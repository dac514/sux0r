...
$gtext['navcontainer'] = array('Home' => suxFunct::makeUrl('/home'),'Feeds' => array(suxFunct::makeUrl('/feeds'), suxFunct::getModuleMenu('feeds')));	
...
$gtext['banned_p1'] = 'Your account has been suspended. Please contact an administrator.';
